...
var interaction = {
	...
	getTypeAndId : function(){
		...
		if (as.length==1) {
			...
			// Youtube
			else if (ref.indexOf("http://youtu.be/")>-1 || ref.indexOf("//www.youtube.com")>-1) {
			...
			// Local
			else if (ref.indexOf("../index.html")==0 || (ref.indexOf("http")!=0 && ref.indexOf("//")!=0)) {
				this.file = ref;
				this.type = 'local';
	...
	init : function(){
		...
		if (this.type=='mediateca') {
			...
			$exe.loadScript("../js/jwplayer.js","interaction.ready()");
			return;
